...
{
	Bond _bond;
	if (_cusip == "91282CFX4") _bond = Bond("91282CFX4", CUSIP, "US2Y", 0.01750, from_string("2024/11/30"));
	if (_cusip == "91282CFW6") _bond = Bond("91282CFW6", CUSIP, "US3Y", 0.01875, from_string("2025/11/15"));
	if (_cusip == "91282CFZ9") _bond = Bond("91282CFZ9", CUSIP, "US5Y", 0.02000, from_string("2027/11/30"));
	if (_cusip == "91282CFY2") _bond = Bond("91282CFY2", CUSIP, "US7Y", 0.02125, from_string("2029/11/30"));
	if (_cusip == "91282CFV8") _bond = Bond("91282CFV8", CUSIP, "US10Y", 0.02250, from_string("2032/11/15"));
	if (_cusip == "912810TM0") _bond = Bond("912810TM0", CUSIP, "US20Y", 0.02250, from_string("2042/11/30"));
	if (_cusip == "912810TL2") _bond = Bond("912810TL2", CUSIP, "US30Y", 0.02750, from_string("2052/11/15"));
	return _bond;
}
...
{
	double _pv01 = 0;
	if (_cusip == "91282CFX4") _pv01 = 0.01948992;
	if (_cusip == "91282CFW6") _pv01 = 0.02865304;
	if (_cusip == "91282CFZ9") _pv01 = 0.04581119;
	if (_cusip == "91282CFY2") _pv01 = 0.06127718;
	if (_cusip == "91282CFV8") _pv01 = 0.08161449;
	if (_cusip == "912810TM0") _pv01 = 0.11245324;
	if (_cusip == "912810TL2") _pv01 = 0.15013155;
	return _pv01;
}
